...
export default function BlogPostPage(): JSX.Element {
  ...
  return (
    <div className='blog_post_container'>
      ...
      {postDetails.body === null ? <div className='post_body'>
        NO BODY //// THIS IS AN EXAMPLE
        NO BODY //// THIS IS AN EXAMPLE
        NO BODY //// THIS IS AN EXAMPLE
        NO BODY //// THIS IS AN EXAMPLE
        NO BODY //// THIS IS AN EXAMPLE
        ...
        SECTION 1.10.33 DE CICERO'S “DE FINIBUS BONORUM ET MALORUM”
